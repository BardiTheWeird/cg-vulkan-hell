...
void LveDevice::createCommandPool(VkCommandPool& commandPool) {
...
void LveDevice::createTextureImage(std::string filepath, VkImage& textureImage, VkDeviceMemory& textureImageMemory) {
  ...
  createImageWithInfo(imageInfo, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, textureImage, textureImageMemory);
...
VkImageView LveDevice::createTextureImageView(VkImage textureImage) {
  ...
  if (vkCreateImageView(device_, &viewInfo, nullptr, &textureImageView) != VK_SUCCESS) {
...
VkSampler LveDevice::createTextureSampler(VkImage textureImage, VkImageView textureImageView) {
